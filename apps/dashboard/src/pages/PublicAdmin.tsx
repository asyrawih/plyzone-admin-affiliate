  ...
  return (
    <div className="mx-auto max-w-5xl p-4 md:p-8">
      <div className="mb-5 flex items-start justify-between gap-3">
        <div><Link to="/" className="text-xs text-[var(--muted)] hover:underline">KLSM Affiliate</Link><h1 className="text-2xl font-semibold">{admin.displayName}</h1><div className="text-sm text-[var(--ink-2)]">Kode referral <code className="rounded bg-[var(--surface-3)] px-1">{admin.referralCode}</code> · <Badge value={admin.status} /></div></div>
